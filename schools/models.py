...
class School(models.Model):
    ...
    province = models.CharField(_('School Province'), max_length=30, choices=PROVINCE_CHOICES)
    district = models.CharField(_('School District'), max_length=50)
    level = models.CharField(_('School Level'), max_length=30, choices=LEVEL_CHOICES)
